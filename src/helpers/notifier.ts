...
class ChangeNotifier {
  ...
  static notify<T>(eventName: string, data: T, caller: string = 'audiox_notifier_default'): void {
  ...
  static listen<T>(eventName: string, callback: ListenerCallback<T>, state = {}): () => void {
    this.validateEventName(eventName);
